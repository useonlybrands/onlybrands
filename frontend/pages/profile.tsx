...
const Profile = () => {
  ...
  const { user, updateProfileWithWorldcoin } = useApi();
  ...
  const [userData, setuserData] = useState({
    ...
    image:
      "https://pbs.twimg.com/profile_images/708090673208033280/_RcBYLyg_400x400.jpg",
  });
  const [worldcoin, setWorlcoin] = useState(false);
            ...
            <Tab.Panel>
              <section className="flex flex-col items-center justify-center py-5 space-y-2 text-gray-800">
                <div className="flex items-end mb-1">
                  ...
                  {
                    <div
                      className="relative top right-5"
                ...
                <div className="flex flex-col items-center justify-center space-y-3">
                  <div className="flex flex-col items-center justify-center space-y-2">
                    <h3 className="mb-1 text-l font-semibold">
                      @{userData.username}
                    </h3>

                    <br></br>

                    <h3 className="mb-1 text-l justify-center items-center space-x-2">
                    ...
                    <h3 className="mb-1 text-l font-normal justify-center items-center space-x-2">
                    ...
                    <div>
                      {!showWallet && (
                        <h3
                          className="text-primary-700 mb-1 text-l font-semibold cursor-pointer"
                      ...
                      {showWallet && (
                        <h3
                          className="mb-1 text-l font-semibold"
                          onClick={toggleWallet}
                        >
                          {userData.wallet}
                        </h3>
