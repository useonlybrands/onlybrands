...
if you wanna deploy 
npx hardhat run scripts/deployment/deployOnly.js --network arbitrumSepolia
 -> UPDATE THE DEPLOY MARKETPLACE WIHT THE NEW TOKEN 
npx hardhat run scripts/deployment/deployMarketplace.js --network arbitrumSepolia

#### manual task

```
npx hardhat settle-up --ad-id 3 --views 23 --marketplace 0x22bF3c1bF4D4b5508Eb2AF99bBE565F7e2375DCb --network spicy  
```

specify ad , views, marketplace and NETWORK!